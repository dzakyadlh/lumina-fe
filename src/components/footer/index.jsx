...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-black border-t border-neutral-700 mt-10 pb-5 px-5">
      <div className="mx-auto w-full max-w-screen-xl py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-500 dark:text-subtitle font-medium">
                <li className="mb-4">
        ...
        <hr className="my-6 border-gray-200 sm:mx-auto dark:border-neutral-700 lg:my-8" />
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-subtitle">
            © 2024{' '}
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a
              href="#twitter"
              className="flex items-center text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5"
            >
